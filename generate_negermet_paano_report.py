...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', default='db/negermet_anomaly_database_15s.csv')
    parser.add_argument('--output', default='negermet_paano_report.html')
    parser.add_argument('--title', default='Детекция негерметичности НКТ методом PaAno (AI)')
    parser.add_argument('--paano-results', default='negermet_paano_results.csv')
    parser.add_argument('--paano-scores', default='db/negermet_paano_scores.csv')

    ...
    <div class="method-box">
        ...
        <ol>
            <li><b>Обучение на норме.</b> Все нормальные участки данных скважины нарезаются на короткие
                фрагменты (патчи). 1D-CNN кодирует каждый патч в вектор-эмбеддинг. Из тренировочных
                эмбеддингов формируется банк нормальных паттернов.</li>
        ...
        <p><b>Особенности для негерметичности НКТ:</b> используется более короткий патч (32 точки = 64 мин)
        для ловли резких, кратковременных аномалий. Порог чувствительности снижен.</p>
    </div>

...
def load_pritok_data(source_path=None):
    if source_path is not None:
        ...
        candidates = [
            DB_DIR / "pritok_anomaly_database_2min.csv",
            DB_DIR / "pritok_anomaly_database_15s.csv",
        ]
...
def run_pritok_paano_detection(
    output_path=RESULTS_DIR / "pritok_paano_results.csv",
    source_path=None,
    verbose=True,
):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default=str(RESULTS_DIR / "pritok_paano_results.csv"))

...
def main() -> None:
    parser = argparse.ArgumentParser(description="Engineered-feature detection for negermet.")
    parser.add_argument("--detector", choices=sorted(DETECTOR_KEYS), default=default_detector_for("negermet"))

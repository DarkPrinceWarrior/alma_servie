"""
Build salt dataset on a uniform grid.
...
def main(freq: str = "15min") -> None:
    build_dataset(get_dataset_spec("salt"), freq=freq)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--freq", default="15min", help="Resample frequency (e.g. 2min, 15min)")

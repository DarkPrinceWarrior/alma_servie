...
Скрипт строит для референсных скважин Plotly-графики:
- исходные ряды по каждому параметру;
- жёлтые прямоугольники — авторские окна НКТ; подписи «Начало/Остановка» внутри зоны;
- красные прямоугольники — интервалы, найденные детектором.

Выход: `reports/anomalies/reference_wells_report.html`.

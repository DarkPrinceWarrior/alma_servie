...
def run_negermet_paano_detection(output_path="negermet_paano_results.csv", source_path=None, verbose=True):
    ...
    pred_output = Path("db/negermet_paano_predicted_starts.csv")
    if pred_rows:
